    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden mesh-gradient">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-28 pb-20">
          ...
          <FadeIn delay={0.2}>
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-serif font-bold leading-[1.05] mb-8">
              <em className="text-brand-coral not-italic font-serif italic">Expert</em> Coaches.
              <br />
              <em className="text-brand-teal not-italic font-serif italic">Supportive</em> community.
            </h1>
          </FadeIn>
            ...
            {[
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="flex items-start gap-6 md:gap-8 p-6 md:p-8 bg-white rounded-2xl shadow-soft card-hover">
                  <span className="flex-shrink-0 text-3xl md:text-4xl font-serif font-bold text-brand-teal/30">
                    {step.num}
                  </span>
                  <div>
      ...
      <section className="py-24 md:py-32 px-6 mesh-gradient-dark">
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            <p className="text-3xl md:text-4xl font-serif italic text-white/90 mb-8 leading-relaxed">
