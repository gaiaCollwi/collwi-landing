              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Build your coaching business with complete autonomy and industry-leading support.
                  </p>
                </div>
                ...
                <div className="space-y-6 pt-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-1">82% Revenue Share</h3>
                      <p className="text-gray-600">Industry-leading earnings. You set rates, you keep what you earn.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-1">Full Autonomy</h3>
                      <p className="text-gray-600">Your schedule, your clients, your approach. We handle the rest.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-1">Simple, Powerful Tools</h3>
                      <p className="text-gray-600">Scheduling, payments, client management built for you.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-1">Access to Clients</h3>
                ...
                <div className="bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-100 rounded-2xl p-6">
                  <div className="text-sm font-medium text-indigo-900 mb-1">Average monthly earnings</div>
                  <div className="text-4xl font-bold text-indigo-900 mb-1">$3,200</div>
                  <div className="text-sm text-indigo-700">Based on 8 sessions/week at $100/session</div>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    id="specialty"
                    required
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition text-gray-900 bg-white"
                ...
                <div>
                  ...
                  <textarea
                    id="certifications"
                    rows={3}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition resize-none text-gray-900"
